            ...
            <div className="option-row">
              ...
              <div className="option-chips">
                ...
                >
                  ...
                  <span className="date-chip-text">{dateTarget === 'start' && isCustomDate || startDateMode === 'custom' ? formatShortKoreanDate(startDate) : '날짜 선택'}</span>
                </button>
              </div>
            </div>
            ...
            <div className="option-row">
              ...
              <div className="option-chips">
                ...
                >
                  ...
                  <span className="date-chip-text">{dateTarget === 'due' && isCustomDate || dueDateMode === 'custom' ? formatShortKoreanDate(dueDate) : '날짜 선택'}</span>
                </button>
              </div>
            </div>
